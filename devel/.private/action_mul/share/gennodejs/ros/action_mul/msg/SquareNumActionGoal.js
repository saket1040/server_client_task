...
let SquareNumGoal = require('./SquareNumGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class SquareNumActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SquareNumGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SquareNumActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SquareNumGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SquareNumGoal()
    }
...
module.exports = SquareNumActionGoal;
